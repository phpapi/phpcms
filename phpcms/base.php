...
//js 路径
define('JS_PATH2',pc_base::load_config('system','js_path2'));
//css 路径
define('CSS_PATH2',pc_base::load_config('system','css_path2'));
//img 路径
define('IMG_PATH2',pc_base::load_config('system','img_path2'));
