...
;(function($){
    ...
    function other_lazy_load_img_init(){
        $("#f_m_t .l").bind("mouseenter",lazy_load_img);
        $("#wy_game_zone .left .l").bind("mouseenter",lazy_load_img);
        $("#f_game_recommend .title .l").bind("mouseenter",lazy_load_img);
        $("#sj_rank .it").bind("mouseenter",lazy_load_img);
    };
    function other_lazy_load_img_remove(){
        $("#f_m_t .l").unbind("mouseenter",lazy_load_img);
        $("#wy_game_zone .left .l").unbind("mouseenter",lazy_load_img);
        $("#f_game_recommend .title .l").unbind("mouseenter",lazy_load_img);
        $("#sj_rank .it").unbind("mouseenter",lazy_load_img);
    };
